...
export const APPS: LabApp[] = [
  {
    ...
    blurb:
      "이미 산 값과 새로 살 값을 넣으면 평단가가 얼마로 내려가는지 바로 보입니다.",
    points: [
      "원하는 평단가를 넣으면 얼마어치를 더 사야 하는지 알려 줍니다.",
      "종목을 저장해 두면 계산한 자리가 이력으로 남습니다.",
    ],
    status: "testing",
...
export const HERO = {
  ...
  define: "Twinkle AI Labs 는 한 사람과 AI 가 만드는 유틸리티 앱 스튜디오입니다.",
...
export const NAMES = [
  {
    ...
    reading: "트윙클 · 반짝이다",
    body:
      "별이 반짝이는 것은 남의 빛을 되비추기 때문이 아니라, 스스로 타고 있기 때문입니다. 그래서 Twinkle 은 이름이자 다짐입니다 — 난 스스로 빛난다. 누가 자리를 만들어 주기를 기다리지 않고, 만들고 싶은 것을 만들어 내놓습니다.",
  },
  {
    word: "Polaris",
    reading: "폴라리스 · 북극성",
    body:
      "북극성은 밤에 길을 잃었을 때 찾는 별입니다. 모든 앱의 이용약관과 개인정보 처리방침은 polaris.twinklelabs.kr 한 자리에 모입니다. 앱은 문서를 제 안에 베껴 넣는 대신 늘 그 주소를 가리킵니다 — 약관이 바뀌어도 앱을 새로 올릴 필요가 없고, 누가 언제 열어도 같은 판을 봅니다.",
...
export const APPS_SECTION = {
  eyebrow: "앱",
  title: "지금까지 만든 것",
  note: "하나를 끝까지 다듬은 다음에 다음을 시작합니다.",
} as const;
...
export const FOUNDER = {
  ...
  stats: [
    ...
    { value: "10+", label: "기획부터 운영까지 맡은 프로젝트" },
    { value: "1 + AI", label: "Twinkle AI Labs 의 조직" },
  ],
  body: [
    "5년 넘게 웹 풀스택 개발자로 일했습니다. 지난 회사에서는 3년 5개월 동안 열 개가 넘는 프로젝트를 기획부터 설계, 개발, 배포, 운영까지 직접 책임졌습니다 — 하이브리드 웹앱을 스토어에 올리고, 서버와 인프라를 세우고, 로봇과 통신하는 시스템까지.",
    "아이디어 하나가 서비스가 되기까지 무엇이 필요한지 전부 겪어 봤다는 것. 혼자서 제품을 만들어 내는 지금, 그것이 가장 큰 자산입니다. 조직은 한 사람과 AI 둘이고, AI 는 저를 대신하지 않고 제 생각을 넓힙니다.",
 ...
 *
 * 색견본은 여기 hex 로 적지 않는다. 이 화면이 그 시스템 위에 서 있으므로
 * 칸마다 **의미 토큰 이름**만 두고, 화면이 `var(--…)` 로 칠한다 —
 * 그래야 라이트·다크를 고를 때 견본도 함께 갈아입는다.
 */
export const DESIGN = {
  eyebrow: "디자인 시스템",
  title: "Aurora Ledger",
...
export const CONTACT = {
  eyebrow: "문의",
  title: "무엇이든 이 주소 하나로",
  body: "앱에 대한 이야기, 버그, 제안 무엇이든 좋습니다. Twinkle AI Labs 는 법인이 아니라 개인이 만들고 운영하는 이름이고, 대외 창구는 메일 하나입니다.",
} as const;
