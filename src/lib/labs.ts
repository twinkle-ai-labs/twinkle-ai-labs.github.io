...
export const APPS: readonly LabApp[] = [
  ...
  },
  {
    slug: "pocket-pdf",
    name: "Pocket PDF",
    tagline: "구독 없이 5,900원 한 번, 문서는 기기 밖으로 나가지 않는 PDF 도구",
    blurb:
      "쓸 만한 PDF 편집 앱은 너무 비쌌습니다. 서명 한 번 넣으려면 달마다 돈을 내라고 하고, 그러면서 문서는 남의 서버에 올려야 했습니다. 도구 여섯을 전부 무료로 열고, 광고를 걷는 값은 구독 없이 5,900원 한 번으로 정했습니다 — 병합도 글자 읽기도 서명도 기기 안에서 끝납니다.",
    points: [
      "스캔·병합·분할·이미지 변환·서명·페이지 편집, 여섯 도구 전부 무료",
      "광고 없애기는 5,900원 한 번 — 구독도 등급도 없이",
